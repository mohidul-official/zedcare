            ...
            <li class="nav-item active">
                ...
                <div id="collapseSupportertimesheet" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="supporter-new.php">New</a>
                    </div>
                </div>
            </li>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">New Support Worker</h1>
                        ...
                        <div class="col-xl-12 col-lg-12">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    ...
                                    <h6 class="m-0 font-weight-bold text-primary">Support Worker Details</h6>
                                    
                                </div>
                                <!-- Card Body -->
                                <div class="card-body">
                                    <form method="post" action="supporterworkeraction.php">
                                        <div class="form-row">
                                        ...
                                        <div class="form-row">
                                            ...
                                            style="">
                                                ...
                                                <input type="text" name="address" class="form-control" id="" palceholder="Enter Suburb" required>
                                            </div>
                                        </div>
                                        <div class="form-row">
                                            <div class="form-group col-md-6"
