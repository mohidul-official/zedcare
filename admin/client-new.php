...
<body id="page-top">
            ...
            <li class="nav-item active">
                ...
                <div id="collapseTwo12client" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="client-new.php">New</a>
                    </div>
                </div>
            </li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-12 col-lg-12">
                            <div class="card shadow mb-4">
                                ...
                                <!-- Card Body -->
                                <div class="card-body">
                                    <form method="post" action="clientaction.php">
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-3">
                                                <input type="text" name="middlename" class="form-control" id="" placeholder="Enter Middle Name" required>
                                        ...
                                        <div class="form-row">
                                            ...
                                            style="">
                                                ...
                                                <input type="text" name="displayname" class="form-control" id="" placeholder="Enter Display Name" required>
                                            </div>
                                            <div class="form-group col-md-6"
                                            style="">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-6"
                                            style="">
                                                <input type="tel" name="mobile" class="form-control" id="" placeholder="Enter Mobile Number" required>
                                            </div>
                                            <div class="form-group col-md-6"
                                            style="">
                                        ...
                                        <div class="form-row">
                                            ...
                                            style="">
                                                ...
                                                <input type="text" name="dob" class="form-control" id="" placeholder="ex: 1990 (YYYY)" required >
                                            </div>
                                            <div class="form-group col-md-3"
                                            style="">
                                                <label for="">Age</label>
                                        ...
                                        <div class="form-row">
                                            ...
                                            style="">
                                                ...
                                                <input type="text" name="address" class="form-control" id="" palceholder="Enter Address" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-row">
                                            ...
                                            style="">
                                                ...
                                                <input type="text" name="religion" class="form-control" id="" placeholder="Enter Religion" required>
                                            </div>
                                            <div class="form-group col-md-6"
                                            style="">
                                                <label for="">Marital Status</label>
                                                <input type="text" name="maritalstatus" class="form-control" id="" placeholder="Enter Marital Status">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-row">
                                            ...
                                            style="">
                                                ...
                                                <input type="text" name="nationality" class="form-control" id="" placeholder="Enter Nationality" required>
                                            </div>
                                            <div class="form-group col-md-6"
                                            style="">
                                                <label for="">Language Spoken</label>
                                                <input type="text" name="languagespoken" class="form-control" id="" placeholder="Enter Language Spoken">
                                            </div>
                                        </div>
                                        <div class="form-row">
                                            <div class="form-group col-md-4"
   ...
   function displayDivDemo(id, elementValue) {
      document.getElementById(id).style.display = elementValue.value == 'Officer' ? 'block' : 'none';
   }
</script>
