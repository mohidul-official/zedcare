...
$dp=$_SESSION['dp'];
$tid=$_GET['id'];
$sql="SELECT * FROM supportertimesheet WHERE id='$tid'";
            ...
            <li class="nav-item active">
                ...
                <div id="collapseSupportertimesheet" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" data-toggle="collapse" href="#supportertimesheet" role="button" aria-expanded="false" aria-controls="supportertimesheet">Timesheet</a>
                        
                            <div class="collapse" id="supportertimesheet">
                                <div class="card card-body" style="margin-left:10px;">
                                    <a class="collapse-item active " href="supporter-pending-timesheet.php">Pending</a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Decline Cause</h1>
                   

                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Update Decline Cause</h6>
                        </div>
                                <div class="card-body">
                                    <form method="post" action="supporter-declinestatus-timesheet.php">
                                        <div class="form-row">
                                            <div class="form-group col-md-6"
                                            style="">
                                                <label for="">Supporter Id</label>
                                                <input type="text" name="sid" class="form-control" id="" value="<?php echo $sid; ?>" readonly>
                                            </div>
                                            <div class="form-group col-md-6"
                                            style="">
                                                <label for="">Delivery Day</label>
                                                <input type="text" name="sid" class="form-control" id="" value="<?php echo $day; ?>" readonly>
                                            </div>
                                        </div>
                                        <div class="form-row">
                                            ...
                                            style="">
                                                ...
                                                <input type="text" name="starttime" class="form-control" id="" value="<?php echo $deliverydate; ?>" readonly>
                                            </div>
                                            <div class="form-group col-md-4"
                                            style="">
                                                <label for="">Start Time</label>
                                                <input type="text" name="starttime" class="form-control" id="" value="<?php echo $starttime1; ?>" readonly>
                                            </div>
                                            <div class="form-group col-md-4"
                                            style="">
                                                <label for="">End Time</label>
                                                <input type="text" name="totaltime" class="form-control" id="" value="<?php echo $endtime1; ?> " readonly>
                                                <input type="hidden" name="id" class="form-control" id="" value="<?php echo $tid; ?>" >
                                            </div>
                                        </div>
                                        <div class="form-row">
                                            <div class="form-group col-md-12"
                                            style="">
                                                <label for="">Decline Cause</label>
                                                <input type="text" name="declinecause" class="form-control" id="" placeholder="Enter Decline Cause" requried>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-4"
                                            style="">
                                                <a href="supporter-pending-timesheet.php" class="btn btn-danger form-control">Cancle</a>
                                            </div>
                                        </div>
                                    </form>
