                                ...
                                <div class="card-body">
                                    ...
                                    <form>
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-10">
                                                <input type="text" name="name" class="form-control" id="" placeholder="" value="<?php echo $username;?>" readonly>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-10">
                                                <input type="text" name="username" class="form-control" id="" placeholder="" value="<?php echo $username;?>" >
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-10">
                                                <input type="text" name="email" class="form-control" id="" placeholder="" value="<?php echo $email;?>" >
