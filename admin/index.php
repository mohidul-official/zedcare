                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-3">
                                                Employees</div>
                                            <div class=" mb-0 font-weight-bold text-gray-800"><a class="btn btn-primary" href="staff-list.php">View All</a></div>
                                        </div>
                                        <div class="col-auto">
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-3">
                                                Forms</div>
                                            <div class=" mb-0 font-weight-bold text-gray-800"><a class="btn btn-primary" href="your-forms.php">View All</a></div>
                                        </div>
                                        <div class="col-auto">
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-3">
                                                Invoice</div>
                                            <div class=" mb-0 font-weight-bold text-gray-800"><a class="btn btn-primary" href="zedcare-invoice.php">View All</a></div>
                                        </div>
                                        <div class="col-auto">
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-3">
                                                Clients</div>
                                            <div class=" mb-0 font-weight-bold text-gray-800"><a class="btn btn-primary" href="client-list.php">View All</a></div>
                                        </div>
                                        <div class="col-auto">
                                            <i class="fas fa-users fa-2x text-gray-300"></i>
                                        </div>
