                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-12 col-lg-12">
                            <div class="card shadow mb-4">
                                ...
                                <!-- Card Body -->
                                <div class="card-body">
                                    <form method="post" action="staffaction.php">
                                        <div class="form-row">
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-6"
                                            style="">
                                                <label for="">Select Carer Or Officer</label>
                                                <select onchange="displayDivDemo('hideValuesOnSelect', this)" id="" class="form-control" name="selectcando">
                                            <option value="Carer">Carer</option>
                                            <option value="Officer">Officer</option>
                                        </select>
                                            </div>
                                            <div id="hideValuesOnSelect" class="form-group col-md-6"
                                            style="">
