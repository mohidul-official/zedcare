                                    ...
                                    <form method="post" action="">
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-6">
                                                <input type="text" name="staffid" class="form-control" id="" placeholder="Enter Staff Id" required>
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                $today=date("Y-m-d");
                                                ?>
                                                <input type="date" name="date" class="form-control" id="" placeholder="Enter date" min="<?php echo $today;?>" required>
                                        ...
                                        <div class="form-row">
                                            ...
                                            style="">
                                                <input type="submit" class="btn btn-primary form-control" value="Search" name="bookingsearch">
                                            </div>
                                        </div>
                                    </form>
                                    ...
                                    <div class="row">
                                            ...
                                            <?php
                                                if(isset($_POST['bookingsearch'])){
                                                    extract($_POST);
                                                    $sql="SELECT * FROM allslot";
                                                    $result=$conn->query($sql);
                                                    if($result->num_rows > 0){
                                                        while($row = $result->fetch_assoc()){
                                                            $slotid=$row['id'];
                                                            $time=$row['time'];
                                                            $sql2="SELECT * FROM staffbooking WHERE staffid='$staffid' AND date='$date' AND slotid='$slotid'";
                                                            $result2=$conn->query($sql2);
                                                            if($result2->num_rows > 0){
                                                                
                                                               echo "<div class='col-sm-2'>" ;
                                                               echo "<p class='btn btn-danger form-control'>$time</p>";
                                                               echo "</div>";
                                                            }else{
                                                                echo "<div class='col-sm-2'>" ;
                                                               echo "<a class='btn btn-success form-control' href='add-task.php?staffid=$staffid&date=$date&slotid=$slotid&time=$time' target='_blank'>$time</a>";
