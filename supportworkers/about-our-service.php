            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">About Our Service</h1>
                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">About Our Service</h6>
                                </div>
                                <div class="card-body">
                                    
                                    <p>ZedCare Ability Services Pty Ltd is a support service provider for people with a disability based in Castle Hill, New South Wales.</p>
                                    <p>ZedCare Ability Services Pty Ltd is an NDIS provider, which allows clients to exercise choice and control. We provide a high-quality service and ensure to meet the needs of all our client, by providing support services tailored to the needs of each individual client.</p>
                                    <p>Our aim is improving the quality of life for people with a disability by delivering high quality support services.</p>
