            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Introduction to Orientation Package</h1>
                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Orientation Package</h6>
                                </div>
                                <div class="card-body">
                                    
                                    <p>This orientation package has been developed to assist all support workers in understanding and implementing ZedCare policies and procedures.</p>
                                    <p>Location of <b>Woodcroft Centre</b>: 39 Blend Pl, Woodcroft NSW 2767</p>
                                    <p>Location of <b>Blacktown Centre</b>: 9 Julie Street, Blacktown NSW 2148</p>
                                    <p>If at any point in time you need further clarification on any of these policies or procedures please do not hesitate to contact our Operational Manager or our House Manger.</p>
                                    <p>Contact Details:<br>
                                    <b>House Manager:</b><br>
                                    Bulou Rakuita<br>
                                    Ph: 0410644138</p>
                                    <p><b>Operational Manager:</b><br>
                                    Stefan Vinen<br>
                                    Ph: 0452488873<br>
                                    Email: <a href="mailto:stefan@zedcare.com.au">stefan@zedcare.com.au</a></p>
