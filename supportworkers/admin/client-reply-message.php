...
require_once('db_connect.php');
                                        ...
                                        if(isset($_POST['submit'])){
                                            ...
                                            extract($_POST);
                                            $sql2="INSERT INTO `ctoainbox`(`cid`, `aid`, `message`, `adminname`, `clientname`, `sendby`, `date`) VALUES ('$cid','$aid','$msg','$adminname','$clientname','$sendby','$date')";
                                            if($conn->query($sql2)===true){
                                                    //header('Location:inbox.php');
                                                    header("Location: client-reply-message.php?cid=" . $cid."&clientname=" . $clientname);
                                                        exit();
                                                    }
                                                else{
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active">
                ...
                <div id="collapseTwo1" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item active" href="chat-with-client.php">Chat With Client</a>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                                <div class="ex3">
                                    <?php
                                        $sql="SELECT * FROM ctoainbox WHERE cid='$cid' AND aid='$aid'";
