            ...
            <li class="nav-item active">
                ...
                <div id="collapseTwo12staff" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item active" href="staff-list.php">List</a>
                ...
                <div class="container-fluid">
                 ...
                 <div class="row">
                   <div class="col-sm-8">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-sm-3">
                                    <img src="https://www.zedcare.com.au/zedcare/admin/<?php echo $staffprofile;?>" alt="staff profile picture" class="img-fluid img-thumbnail img-rectangle"><br>
                                    ...
                                    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <form action="staffdpaction.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Compliance <span style="float:right;"><a href="#">Manage All</a></span></h6>
                        </div>
                        <div class="card-body">
                            <table style="width:100%;text-align:center;">
                                ...
                                <tr style="margin-top:10px;margin-bottom:10px;">
                                    ...
                                    <td></td>
                                    <td></td>
                                    <td><p class="el-tag el-tag-warning">Not Specified</p></td>
                                </tr>
                   ...
                   <div class="col-sm-4">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Login<span style="float:right;">3 days ago</span></h6>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-8 mb-3">
                                    <p class="el-tag"><?php echo $role; ?></p>
                                </div>
                            </div>
                            
                            <div class="row">
                                <div class="col-sm-4 font-weight-bold mb-2">
                                    Notify Attendance Approval:
                                </div>
                                <div class="col-sm-8 mb-3">
                                    <?php
                                    if($notifyattendance==$y){
                                    ?>
                            ...
                            <div class="row">
                                <div class="col-sm-4 font-weight-bold mb-2">
                                    Available For Rostering:
                                </div>
                                <div class="col-sm-8 mb-3">
                                    <?php
                                    if($availablerostering==$y){
                                    ?>
                                    <i class="fas fa-check"></i>
                                    <?php
                                    }else{
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Next of Kin <span style="float:right;"><a data-toggle="collapse" href="#collapseExamplenextofkin" role="button" aria-expanded="false" aria-controls="collapseExamplenextofkin">Edit</a></span></h6>
                        </div>
                        <div class="card-body">
                            
                            <div class="row">
                                <div class="col-sm-4 font-weight-bold mb-1">
                                    Name:
                                </div>
                                <div class="col-sm-8 mb-3">
                                    <?php echo $kinname; ?>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-8 mb-3">
                                    <i class="fas fa-phone-square"></i> <?php echo $kincontact; ?>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-8 mb-3">
                                    <i class="fas fa-envelope"></i> <?php echo $kinemail; ?>
                                </div>
                            </div>
                            
                            <div class="collapse mt-2" id="collapseExamplenextofkin">
                            <div class="row">
                              
                                <div class="card-body">
                                    <form method="post" action="staffkineditaction.php">
                                        <div class="form-row">
                                            <div class="form-group col-md-12"
                                            style="">
                                                ...
                                                <input type="text" class="form-control" placeholder="Name" value="<?php echo $kinname; ?>" name="kinname">
                                            </div>
                                        </div>
                                        <div class="form-row">
                                            <div class="form-group col-md-12"
                                            style="">
                                                ...
                                                <input type="text" class="form-control" placeholder="Relation" value="<?php echo $kinrelation; ?>" name="kinrelation">
                                        ...
                                        <div class="form-row">
                                            ...
                                            style="">
                                                ...
                                                <input type="text" class="form-control" placeholder="Mobile" value="<?php echo $kincontact; ?>" name="kincontact">
                                            </div>
                                        </div>
                                        <div class="form-row">
                                            <div class="form-group col-md-12"
                                            style="">
                                                ...
                                                <input type="email" class="form-control" placeholder="Email" value="<?php echo $kinemail; ?>" name="kinemail">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-4"
                                            style="">
                                                <button class="btn btn-danger form-control" type="button" data-toggle="collapse" data-target="#collapseExamplenextofkin" aria-expanded="false" aria-controls="collapseExamplenextofkin">Cancle</button>
                                            </div>
                                        </div>
                                    </form>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Payroll Settings <span style="float:right;"><a data-toggle="collapse" href="#collapseExamplepayrole" role="button" aria-expanded="false" aria-controls="collapseExamplepayrole">Edit</a></span></h6>
                        </div>
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-8 mb-3">
                                    <p class="el-tag"><?php echo $paygroup; ?></p>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-8 mb-3">
                                    <?php echo $externalsystemidentifier; ?>
                                </div>
                            </div>
                            
                            <div class="collapse mt-1" id="collapseExamplepayrole">
                            <div class="row">
                              
                                <div class="card-body">
                                    <form method="post" action="staffpayroleeditaction.php">
                                        <div class="form-row">
                                            <div class="form-group col-md-12"
                                            style="">
                                                
                                                <label for="">Pay group</label>
                                                
                                                
                                                <select id="" class="form-control" name="paygroup">
                                            <option value="Default Casual">Default Casual</option>
                                            <option value="-">-</option>
                                        </select>
                                            </div>
                                        </div>
                                        <div class="form-row">
                                            ...
                                            style="">
                                                ...
                                                <select id="" class="form-control" name="allowances">
                                            <option value="Demo Allowances">Demo Allowances</option>
                                            <option value="-">-</option>
                                        </select>
                                            </div>
                                        </div>
                                        <div class="form-row">
                                            ...
                                            style="">
                                                ...
                                                <input type="text" class="form-control" value="<?php echo $dailyhours; ?>" name="dailyhours">
                                        ...
                                        <div class="form-row">
                                            ...
                                            style="">
                                                ...
                                                <input type="text" class="form-control" value="<?php echo $weeklyhours; ?>" name="weeklyhours" >
                                            </div>
                                        </div>
                                        <div class="form-row">
                                            <div class="form-group col-md-12"
                                            style="">
                                                ...
                                                <label for="">External System Identifier</label>
                                                
                                                
                                                <input type="text" class="form-control" value="<?php echo $externalsystemidentifier; ?>" name="externalsystemidentifier">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-4"
                                            style="">
                                                <button class="btn btn-danger form-control" type="button" data-toggle="collapse" data-target="#collapseExamplepayrole" aria-expanded="false" aria-controls="collapseExamplepayrole">Cancle</button>
                                            </div>
                                        </div>
                                    </form>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Notes <span style="float:right;"><a data-toggle="collapse" href="#collapseExamplenote" role="button" aria-expanded="false" aria-controls="collapseExamplenote">Edit</a></span></h6>
                        </div>
                        <div class="card-body">
                 ...
                 <div class="row">
                   <div class="col-sm-12">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Archive Staff</h6>
                        </div>
                        <div class="card-body">
                            <p>This will archive the staff and you will not able to see staff in your list. If you do wish to access the staff, please go to  <a href="staff-archived.php">Archived menu</a>.</p>
                                ...
                                <div class="modal" id="myModal">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <!-- Modal footer -->
                                            <div class="modal-footer">
                                                <a href="staff-archive.php?id=<?php echo $id;?>" class="btn btn-success">Yes</a>
