...
if(isset($_POST['submit'])){
	...
	$c="E";
	$eid=$c.$r.$date;
	$sql2="INSERT INTO `employees`(`eid`, `email`, `password`, `name`, `suburb`, `state`, `postcode`, `date`, `role`, `status`) VALUES ('$eid','$email','$password','$name','$suburb','$state','$postcode','$date1','$role','$status')";
