...
$sid=$_GET['sid'];
$supportername=$_GET['supportername'];
$sid=$_GET['sid'];
$aid="A1234567890";
$adminname="ZedCare";
require_once('db_connect.php');
                                        ...
                                        if(isset($_POST['submit'])){
                                            ...
                                            extract($_POST);
                                            $sql2="INSERT INTO `stoainbox`(`sid`, `aid`, `message`, `adminname`, `supportername`, `sendby`, `date`) VALUES ('$sid','$aid','$msg','$adminname','$supportername','$sendby','$date')";
                                            if($conn->query($sql2)===true){
                                                    //header('Location:inbox.php');
                                                    header("Location: reply-message.php?sid=" . $sid."&supportername=" . $supportername);
                                                        exit();
                                                    }
                                                else{
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
                ...
                <div class="sidebar-brand-text mx-3">ZedCare</div>
            </a>
            ...
            <li class="nav-item active">
                ...
                <div id="collapseTwo1" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="chat-with-supporter.php">Chat With Supporter</a>
                    </div>
                </div>
            </li>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Chat With Supporter</h1>
                   

                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">All Chats</h6>
                        </div>
                        <div class="card-body">
                                <div class="ex3">
                                    <?php
                                        $sql="SELECT * FROM stoainbox WHERE sid='$sid' AND aid='$aid'";
                                    ...
                                    <div class="box arrow-right">
                                        <div class="message-body">
                                            <p style="margin-bottom: 0px;">Hello world! This is a test message to show how to make an arrow on the side of the box.</p>
                                        </div>
                                    </div>-->
                                ...
                                <div style="background-color: lightblue;">
                                    <form method="post" action="">
                                        ...
                                        <div class="row">
                                            ...
                                            <input type="hidden" name="supportername" value="<?php echo "$supportername"; ?>">
                                            <input type="hidden" name="adminname" value="<?php echo "$adminname"; ?>">
                                            <input type="hidden" name="sendby" value="<?php echo "$aid"; ?>">
                                            <?php
...
?>
                                            ...
                                            <div class="col-md-9 mb-4 mt-4" style="margin-left: 30px;"><input type="text" name="msg" class="form-control" placeholder="Enter Message"></div>
                                            <div class="col-md-2 mb-4 mt-4"><input type="submit" name="submit" value="submit" class="form-control btn btn-primary"></div>
