        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Add Clients Care Plan</h1>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <form action="addcareplan-action.php" method="post">
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        <label for="">Organisation Name</label>
                                        <input type="text" class="form-control" id="" name="organisationname">
                                    </div>
                                    <div class="form-group col-md-6">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="email" class="form-control" id="FileName" placeholder="example@example.com" name="email">
                                    </div>
