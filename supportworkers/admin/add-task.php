...
$sql2="SELECT * FROM allslot WHERE slotid='$slotid'";
...
/*$sql3="SELECT * FROM allslot WHERE slotid='$slotid'";
            ...
            <li class="nav-item ">
                ...
                <div id="collapseTwo12staff" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="staff-new.php">New</a>
                    </div>
                </div>
            </li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-12 col-lg-12">
                            <div class="card shadow mb-4">
                                ...
                                <!-- Card Body -->
                                <div class="card-body">
                                    <form method="post" action="addtaskaction.php">
                                        <div class="form-row">
                                            
                                            <div class="form-group col-md-6">
                                                <label for="">Staff Id</label>
                                                <input type="text" name="staffid" class="form-control" id="" placeholder="Enter Staff Id" value="<?php echo $staffid;?>" required readonly>
      
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label for="">Staff Name</label>
                                                <input type="text" name="staffname" class="form-control" id="" value="<?php echo $fullname;?>" required readonly>
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" name="time" class="form-control" id="" placeholder="Enter Staff Id" value="<?php echo $time;?>" required readonly>
                                                <input type="hidden" name="slotid"  value="<?php echo $slotid;?>" >
      
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label for="">Date</label>
                                                <input type="text" name="date" class="form-control" id="" value="<?php echo $date;?>" required readonly>
                                        ...
                                        <div class="form-row">
                                            ...
                                            style="">
                                                <input type="submit" class="btn btn-primary form-control" value="Search" name="">
                                            </div>
                                        </div>
                                    </form>
