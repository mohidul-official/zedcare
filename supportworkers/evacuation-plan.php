            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Evacuation Plan</h1>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">WOODCROFT CENTRE Evacuation Plan</h6>
                                </div>
                                <div class="card-body">
                                    <img src="img/w-d-e-plan.png" width="100%">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">BLACKTOWN CENTRE Evacuation Plan</h6>
                                </div>
                                <div class="card-body">
                                    <img src="img/b-c-e-plan.png" width="100%">
