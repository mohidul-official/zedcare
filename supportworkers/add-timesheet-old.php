            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <form action="addtimesheet-action.php" method="post">
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        <label for="">Supporter Id</label>
                                        <input type="text" class="form-control" id="" name="sid" value="<?php echo $sid;?>" readonly>
                                    </div>
                                    <!--<div class="form-group col-md-6">
                                        <label for="">Client Id</label>
                                        <input type="tel" class="form-control" id="" name="cid" >
                                    </div>-->
                                    <div class="form-group col-md-6">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control" id="" name="deliverydate" placeholder="ex:2021-12-20 (YYYY-MM-DD)">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="">Start Time</label>
                                        <input type="text" class="form-control" id="" name="starttime" placeholder="Ex: 12:00 PM">
                                    </div>
                                </div>
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        <label for="">Total Time (Hours)</label>
                                        <input type="text" class="form-control" id="" name="totaltime">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <input type="hidden" class="form-control" id="" name="rate" value="Null">
                                    </div>
                                    <!--<div class="form-group col-md-6">
                                        <label for="">Rate (Per Hour)</label>
                                        <select class="form-control" id="" name="rate">
