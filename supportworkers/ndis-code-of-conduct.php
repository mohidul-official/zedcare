            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Code of Conduct NDIS</h1>
                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Code of Conduct NDIS</h6>
                                </div>
                                <div class="card-body">
                                    
                                    
                                    <p><b><u>NDIS Code of Conduct</u></b></p>
                                    <p>In providing supports or services to people with disability, a Code-covered person must:</p>
                                    
                                        <ul>
                                            <li>act with respect for individual rights to freedom of expression, self-   determination and decision-making in accordance with applicable laws and conventions; and </li>
                                            <li>respect the privacy of people with disability; and  </li>
                                            <li>provide supports and services in a safe and competent manner, with care   and skill; and </li>
                                            <li>act with integrity, honesty and transparency; and </li>
                                            <li>promptly take steps to raise and act on concerns about matters that may impact the quality and safety of supports and services provided to people with disability; and  </li>
                                            <li>take all reasonable steps to prevent and respond to all forms of violence against, and exploitation, neglect and abuse of, people with disability; and </li>
